    ...
    if (window.File && window.FileReader && window.FileList && window.Blob) {
      var s = {
        ...
        messages: {
          ...
          remove: "Remover",
          error: "Ooops, algo malo se ha añadido.",
        },
        error: {
        ...
        tpl: {
          ...
          message:
            '<div class="dropify-message"><span class="mdi mdi-cloud-upload-outline"  style="font-size: 100px; color:#ff820c" /> <p>{{ default }}</p></div>',
          preview:
          ...
          filename:
            '<p class="dropify-filename"><span class="mdi mdi-cloud-upload-outline"></span> <span class="dropify-filename-inner"></span></p>',
          clearButton:
